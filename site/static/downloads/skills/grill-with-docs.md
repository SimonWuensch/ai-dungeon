...
description: Ein rücksichtsloses Interview, das eine Idee schärft und dabei CONTEXT.md/ADRs aktualisiert.
...
1. **Das reine Interview-Prinzip**: Runden, die Frontier (der nächste offene Ast), Fakten sind
   Aufgabe der KI, Entscheidungen bleiben bei dir.
...
Erster Kettenschritt im Hauptfluss, mündet in `to-spec`. Gesamtüberblick: `ask-matt`.
